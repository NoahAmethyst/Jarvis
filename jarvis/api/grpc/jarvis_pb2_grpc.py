...
class JarvisServiceStub:
    ...
    def __init__(self, channel):
        ...
        self.Ingest = channel.unary_unary(
                ...
                request_serializer=jarvis__pb2.IngestRequest.SerializeToString,
                response_deserializer=jarvis__pb2.IngestResponse.FromString,
                _registered_method=True)
        self.GetMemory = channel.unary_unary(
                '/jarvis.JarvisService/GetMemory',
        ...
        self.DeleteMemory = channel.unary_unary(
                '/jarvis.JarvisService/DeleteMemory',
                request_serializer=jarvis__pb2.MemoryRequest.SerializeToString,
                response_deserializer=jarvis__pb2.DeleteResponse.FromString,
                _registered_method=True)
...
def add_JarvisServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'Ingest': grpc.unary_unary_rpc_method_handler(
                    ...
                    response_serializer=jarvis__pb2.IngestResponse.SerializeToString,
            ),
            ...
            'DeleteMemory': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=jarvis__pb2.MemoryRequest.FromString,
                    response_serializer=jarvis__pb2.DeleteResponse.SerializeToString,
            ),
    }
...
class JarvisService:
    ...
    def Ingest(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/jarvis.JarvisService/Ingest',
            jarvis__pb2.IngestRequest.SerializeToString,
            jarvis__pb2.IngestResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
    ...
    def DeleteMemory(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            '/jarvis.JarvisService/DeleteMemory',
            jarvis__pb2.MemoryRequest.SerializeToString,
            jarvis__pb2.DeleteResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
